  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="View the RSVP questions all your guests will see when you send out your e-invitations via your SHIV account."
        />
        <link
          rel="canonical"
          href="https://shiv-worldwide.com/rsvp/questions"
        ></link>
        <title>SHIV RSVP PAGE – Asian Wedding Specialist |SHIV</title>
      </Helmet>
      <div>
                      ...
                      {question.question_type === "Calendar" && (
                        <div className="question">
                          <DatePicker
                            ...
                            name={`question${question.id}`}
                            selected={
                              formData[`question${question.id}`] || null
                            }
                            onChange={(date) => {
                              handleInputChange({
                                target: {
